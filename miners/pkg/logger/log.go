...
// Fatal logs an error message with multiple variables
func (l *Logger) Fatalf(message string, variables ...interface{}) {
	l.logrus.Fatalf(formatMessage(message, variables...))
}
